	...
	<div id="wrap">
		...
		<form action="/sundries/invite/post" method="POST">
			...
			<p>Hello 
				...
				<textarea  name="message" value="Your Message" id="message" readonly="readonly">为响应国家对于培养大学生创新精神的号召，且适逢学校将计划于下学期开展“互联网 + ”大赛，本团队现有“易迅”项目，鉴于正值暑期时间，时间稍微宽裕，本团队想诚挚邀请你参与本项目。</textarea>
				<p>Best,</p>	
